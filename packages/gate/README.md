...
`createJevGate` は、鍵と方針の文章を受け取ります。
受け取ったものから、判定の口を作ります。
...
返ってきた確率が境目以上なら通し、下回れば断ります。

境目は渡せます。省くと 0.5 になります。
確率の数値そのものは、外にも記録にも残しません。

判定そのものが失敗したときは、道具を動かしません。
LLM の実装と同じ振る舞いです。
